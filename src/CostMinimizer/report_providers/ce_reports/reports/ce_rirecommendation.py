...
class CeRirecommendation(CeBase):
	...
	def name(self): #required - see abstract class
		return 'ce_rirecommendation'

	def long_name(self):
		return CeBase.long_name()

	def common_name(self) -> str:
		return 'RI RECOMMENDATION view'
	...
	def description(self): #required - see abstract class
		return '''Montly CostExplorer Reserved Instance (RI) Recommendation View.'''
	
	def long_description(self) -> str:
		return f'''CostExplorer Reserved Instance (RI) Recommendation View:
		This report provides AI-driven recommendations for RI purchases based on your usage patterns.
		It includes:
		- Suggested RI purchase quantities and types
		- Estimated cost savings from following recommendations
		- Payback periods and break-even analysis
		Use these recommendations to make informed decisions about RI investments and maximize your potential cost savings.'''
