...
class CeCredits(CeBase):
	...
	def description(self): #required - see abstract class
		return '''Montly CostExplorer Credits View'''
	
	def long_description(self):
		return f'''CostExplorer Credits View:
		This report provides detailed information about AWS credits applied to your account.
		AWS credits are promotional credits that can offset eligible AWS service charges.
		The Credits view shows:
		- Types of credits applied (e.g., AWS Promotional Credits, AWS Marketing Credits)
		- Amount of credits used per billing period
		- Remaining credit balance
		Use this report to track credit usage, plan for credit expiration, and understand how credits impact your overall AWS spending.'''
	...
	def sql(self, replace=True, query_type='sql_s_r'): #required - see abstract class
		return { "Name":"Credits", "GroupBy": [], "Style": "Total", "CreditsOnly":True }
