...
class CeTotal(CeBase):
	...
	def long_description(self) -> str:
		...
		It displays total spend over the specified lookback period (1-12 months).
		Use this view to:
		- Track and analyze global spending trends over time.'''
	...
	def sql(self, replace=True, query_type='sql_s_r'): #required - see abstract class
		return { "Name":"Total", "GroupBy": [], "Style":'Total',"IncSupport": True }
