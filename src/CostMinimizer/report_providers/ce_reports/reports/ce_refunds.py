...
class CeRefunds(CeBase):
	...
	def description(self): #required - see abstract class
		return '''Montly CostExplorer Refunds View.'''
	
	def long_description(self):
		return f'''CostExplorer Refunds View:
		This report provides a detailed overview of refunds applied to your AWS account.
		It includes information on:
		- Service-specific refunds (e.g., EC2, S3)
		- Refund amounts and dates
		- Reasons for refunds (when available)
		Use this view for financial reconciliation, auditing, and understanding the impact of refunds on your overall AWS costs.'''
	...
	def sql(self, replace=True, query_type='sql_s_r'): #required - see abstract class
		return { "Name":"Refunds", "GroupBy": [], "Style": "Total", "RefundOnly": True }
