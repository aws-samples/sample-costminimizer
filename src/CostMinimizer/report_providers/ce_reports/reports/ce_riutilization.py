...
class CeRiutilization(CeBase):
	...
	def name(self): #required - see abstract class
		return 'ce_riutilization'

	def long_name(self):
		return CeBase.long_name()

	def common_name(self) -> str:
		return 'RI UTILIZATION view'
	...
	def description(self): #required - see abstract class
		return '''Montly CostExplorer Reserved Instance (RI) Utilization View.'''
	
	def long_description(self) -> str:
		return f'''CostExplorer Reserved Instance (RI) Utilization View:
		This report provides insights into how effectively you are using your purchased RIs.
		RI utilization measures the percentage of your purchased RI hours that are actually being used.
		The report shows:
		- RI utilization percentage over time
		- Unused RI capacity and potential waste
		Use this view to identify underutilized RIs and take actions to improve utilization, such as modifying instance types or transferring RIs between accounts.'''
