...
class CeTotalinclcredits(CeBase):
	...
	def description(self): #required - see abstract class
		return '''Montly CostExplorer Total Spend Incl Credits View.'''
	
	def long_description(self) -> str:
		return f'''CostExplorer Total Spend Incl Credits View:
		This report total spends including credits for AWS costs.'''
	...
	def sql(self, replace=True, query_type='sql_s_r'): #required - see abstract class
		return { "Name":"TotalInclCredits", "GroupBy": [], "Style": "Total", "NoCredits":False, "IncSupport":True }
