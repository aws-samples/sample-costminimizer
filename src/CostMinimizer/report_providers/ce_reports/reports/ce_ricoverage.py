...
class CeRicoverage(CeBase):
	...
	def name(self): #required - see abstract class
		return 'ce_ricoverage'

	def long_name(self):
		return CeBase.long_name()

	def common_name(self) -> str:
		return 'RI COVERAGE view'
	...
	def description(self): #required - see abstract class
		return '''Montly CostExplorer Reserved Instance (RI) Coverage View.'''
	
	def long_description(self) -> str:
		return f'''CostExplorer Reserved Instance (RI) Coverage View:
		This report provides insights into your RI utilization and coverage.
		RI coverage refers to the percentage of your eligible EC2 usage that is covered by RIs.
		The report shows:
		- RI coverage percentage over time
		- Potential savings from increased RI coverage
		Use this view to identify opportunities for purchasing additional RIs to optimize costs and increase coverage for your EC2 instances.'''
