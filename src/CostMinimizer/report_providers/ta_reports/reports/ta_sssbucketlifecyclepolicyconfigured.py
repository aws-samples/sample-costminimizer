...
class TaSssbucketlifecyclepolicyconfigured(TaBase):

    def name(self):
        return "ta_sssbucketlifecyclepolicyconfigured"

    def common_name(self):
        return "Amazon S3 Bucket Lifecycle Policy Configured"
    ...
    def description(self):
        return "Identifies Amazon S3 buckets with lifecycle policies configured and analyzes their effectiveness"

    def long_description(self):
        return f'''This check analyzes your Amazon S3 buckets and identifies those that have lifecycle policies configured. 
        It examines the effectiveness of these policies in managing object versions and reducing storage costs.
        Results include:
        - S3 bucket name
        - Region
        - Current lifecycle policy details
        - Estimated storage cost savings from the policy
        - Recommendations for policy improvements
        Use this information to optimize your S3 storage costs by refining and improving your bucket lifecycle policies.'''
    ...
    def _set_recommendation(self):
        self.recommendation = f'''Returned {self.count_rows()} rows analyzing Amazon S3 buckets with lifecycle policies configured'''
