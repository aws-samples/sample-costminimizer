...
class TaRdsreservedinstanceoptimization(TaBase):

    def name(self):
        return "ta_rdsreservedinstanceoptimization"

    def common_name(self):
        return "Amazon Relational Database Service (RDS) Reserved Instance Optimization"
    ...
    def description(self):
        return "Identifies potential cost savings by optimizing Amazon RDS Reserved Instances"

    def long_description(self):
        return f'''This check analyzes your Amazon RDS usage patterns and identifies opportunities to optimize your Reserved Instance purchases. 
        It compares your current RDS usage with your existing Reserved Instances and suggests potential modifications or new purchases that could lead to cost savings. 
        The check considers factors such as instance types, regions, and usage patterns to provide tailored recommendations.
        Results include:
        - Current RDS instance usage and existing Reserved Instance coverage
        ...
        Use this information to optimize your Amazon RDS costs by making informed decisions about Reserved Instance purchases and utilization.'''
    ...
    def _set_recommendation(self):
        self.recommendation = f'''Returned {self.count_rows()} rows summarizing potential cost savings from optimizing Amazon RDS Reserved Instances'''
