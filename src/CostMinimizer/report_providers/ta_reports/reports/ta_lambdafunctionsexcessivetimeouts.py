...
class TaLambdafunctionsexcessivetimeouts(TaBase):
    ...
    def name(self):
        return "ta_lambdafunctionsexcessivetimeouts"

    def common_name(self):
        return "AWS Lambda Functions with Excessive Timeouts"
    ...
    def description(self):
        return "Identifies AWS Lambda functions with excessive timeouts"

    def long_description(self):
        return f'''This check analyzes your AWS Lambda functions and identifies those with excessive timeouts. 
        It examines the timeout rates of your Lambda functions over a specified period and flags functions that exceed a certain threshold.
        Results include:
        - Lambda function name and ARN
        - Timeout rate percentage
        - Number of invocations and timeouts
        - Suggested actions to investigate and resolve excessive timeouts
        Use this information to improve the reliability and performance of your Lambda functions by addressing functions with excessive timeouts.'''
    ...
    def _set_recommendation(self):
        self.recommendation = f'''Returned {self.count_rows()} rows identifying AWS Lambda functions with excessive timeouts'''
