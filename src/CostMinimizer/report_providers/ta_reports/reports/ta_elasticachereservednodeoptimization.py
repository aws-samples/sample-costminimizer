...
class TaElasticachereservednodeoptimization(TaBase):

    def name(self):
        return "ta_elasticachereservednodeoptimization"

    def common_name(self):
        return "Amazon ElastiCache Reserved Node Optimization"
    ...
    def description(self):
        return "Identifies potential cost savings by optimizing Amazon ElastiCache Reserved Nodes"

    def long_description(self):
        return f'''This check analyzes your Amazon ElastiCache usage patterns and identifies opportunities to optimize your Reserved Node purchases. 
        It compares your current ElastiCache usage with your existing Reserved Nodes and suggests potential modifications or new purchases that could lead to cost savings. 
        The check considers factors such as node types, regions, and usage patterns to provide tailored recommendations.
        Results include:
        - Current ElastiCache node usage and existing Reserved Node coverage
        ...
        Use this information to optimize your Amazon ElastiCache costs by making informed decisions about Reserved Node purchases and utilization.'''
    ...
    def _set_recommendation(self):
        self.recommendation = f'''Returned {self.count_rows()} rows summarizing potential cost savings from optimizing Amazon ElastiCache Reserved Nodes'''
